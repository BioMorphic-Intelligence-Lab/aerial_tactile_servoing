...
It was formerly a git submodule pinned to release `v1.17.0`, and was absorbed into this repository (originally
by commit `b05ca5e`, 2025-11-04, older version. Updated 31-8-2026).

**Firmware coupling:** these uORB message definitions must match the PX4 firmware running on the
Pixhawk — **v1.17.0** (see `px4_params/fc_params_vbats.params`). If they drift from the
